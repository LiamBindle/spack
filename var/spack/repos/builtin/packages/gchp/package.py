...
class Gchp(CMakePackage):
    ...
    url      = "https://github.com/geoschem/GCHP/archive/feature/spack-pipeline-self-contained.tar.gz"
    git      = "https://github.com/geoschem/GCHP.git"
    maintainers = ['lizziel', 'laestrada']

    version('feature/spack-pipeline-self-contained', commit='aa1cfb4a9e6ef672c70541220bcd21dcf87b358f',  submodules=True)
